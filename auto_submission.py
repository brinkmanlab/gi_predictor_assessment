...
def predictbias_submit(gbk_path, genome):
    ...
    upload.send_keys(gbk_path+genome+".gbk")
    ...
    # The following code is to rename the download to the proper label and move
    ...
    if len(result_file) == 1:
        ...
        print("Multiple files in downloads - result not renamed/moved")
    else:
